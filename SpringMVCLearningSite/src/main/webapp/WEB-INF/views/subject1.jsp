...
<%
   ...
   for (BoardTO to : lists) {
      if (to.getSubject().equals("일본 역사와 한일 관계")) {
...
<div class="con_txt">
   <div class="contents_sub">
      <div class="board">
         ...
         <tr>
            <th width="3%">&nbsp;</th>
            <th width="7%" style="background-color:lightGray"><a href="subject1.do">일본 역사와 한일 관계</a></th>
            ...
            <th width="7%"><a href="subject5.do">청년과 학자</a></th>
            <th width="3%">&nbsp;</th>
         </tr>
         </table>
      </div>   
