...
<form action="./write_ok.do" method="post" name="wfrm">
		<div class="contents_sub">
			...
			<div class="board_write">
				...
				<tr>
					<th>제목</th>
					<td colspan="3"><input type="text" name="title" size="150" value="" class="board_write_input"/></td>
				</tr>
				<tr>
					<th>유튜브 링크</th>
					<td colspan="3"><input type="text" name="link" size="150" value="" class="board_write_input" /></td>
				</tr>
				<tr>
					<th>내용</th>
					<td colspan="3">
